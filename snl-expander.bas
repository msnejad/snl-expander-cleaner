...
Sub export_to_excel()
'Exports "Updated" sheet generated by data_retriever() to a standalone excel file
...
Sub export_to_csv()
'Exports "Updated" sheet generated by data_retriever() to a standalone CSV file
...
newFile.Sheets(1).Range("A2").Select
Selection.End(xlToRight).Select
newFile.Sheets(1).Columns("P:P").Select
newFile.Sheets(1).Range("P2").Activate
